        ...
        protected void onPostExecute(String s) {
            ...
            for (int i=0; i<nodeList.getLength();i++){
                ...
                if(title.contains("("+a2+")") ==  true) {
                    ...
                    Float giatri = Float.parseFloat(description.substring(vitri+2, vitri+8).trim());
                    Float ketqua = Float.parseFloat(String.valueOf(txt.getText())) * giatri;
                    txtkq.setText("Kết quả: "+String.valueOf(ketqua));
